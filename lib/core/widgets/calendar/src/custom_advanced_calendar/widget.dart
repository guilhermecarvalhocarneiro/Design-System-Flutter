...
class AdvancedCalendarCustom extends StatefulWidget {
  const AdvancedCalendarCustom(
      {Key? key,
      this.controller,
      this.startWeekDay,
      this.events,
  ...
  @override
  _AdvancedCalendarCustomState createState() => _AdvancedCalendarCustomState();
}

class _AdvancedCalendarCustomState extends State<AdvancedCalendarCustom> with SingleTickerProviderStateMixin {
